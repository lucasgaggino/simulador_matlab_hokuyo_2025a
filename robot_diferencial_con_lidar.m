...
addpath('localization_matchscan');
...
ubicado = false;                %poner en true cuando el robot haya terminado la parte de ubicarse
       %cantidad de particulas en el filtro
...
scaleFactor = 2;                %decimar lecturas de lidar acelera el algoritmo
...
current_state = 'LOCALIZATION';  % Estado actual de la maquina de estados
    ...
    %% COMPLETAR ACA:
        ...
        if idx > 2 && exist('ranges', 'var')
            ...
            switch current_state
                ...
                otherwise
                    [v_cmd,w_cmd] = controller.getVelocities(estimated_pose);
            end
        end
